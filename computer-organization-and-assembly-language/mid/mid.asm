...
.STACK 100H
.DATA     
    MSG1 DB 'ENTER CURRENT TEMP: ?' 
    CURRENT_TEMP DB ?
    THRESHOLD_TEMP DB 100
    ALERT_MSG DB 'ALERT!! CURRENT TEMPERATURE EXCEEDS THRESHOLD TEMPERATURE :(' 
    NORMAL_MS DB 'TEMPERATURE IS NORMAL :)'
